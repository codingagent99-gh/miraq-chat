...
# The baseline "backpack" for new conversations
DEFAULT_CONTEXT = {
    "schema_version": "1.0",
...
class Conversation(db.Model):
    ...
    context_data = db.Column(JSONB, nullable=False, default=lambda: copy.deepcopy(DEFAULT_CONTEXT))
...
# Explicit event listener to guarantee updated_at fires correctly in Flask-SQLAlchemy
